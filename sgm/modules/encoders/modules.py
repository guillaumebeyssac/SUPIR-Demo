    ...
    def text_transformer_forward(self, x: torch.Tensor, attn_mask=None):
        ...
        for i, r in enumerate(self.model.transformer.resblocks):
            ...
            if (
                ...
                # Pass None for attn_mask instead of the input attn_mask
                x = checkpoint(r, x, None)
            else:
                # Pass None for attn_mask instead of the input attn_mask
...
class FrozenOpenCLIPEmbedder(AbstractEmbModel):
    ...
    def encode_with_transformer(self, text):
        ...
        # Modified part: Pass None instead of self.model.attn_mask to avoid dimension mismatch
        for i, r in enumerate(self.model.transformer.resblocks):
            ...
            if (
                ...
                x = checkpoint(r, x, None)  # Changed attn_mask to None
            else:
                x = r(x, attn_mask=None)  # Changed attn_mask to None
